...
import { Heart, Activity, TrendingUp, ChevronRight, Pill, Moon, Dumbbell } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVars}>
        <Card className="border-none shadow-sm overflow-hidden bg-gradient-to-br from-primary/20 via-primary/10 to-blue-50/50 mb-6">
          <CardContent className="p-6">
            <div className="flex justify-between items-start mb-4">
              <h2 className="font-bold text-lg text-primary-foreground/80 text-gray-800">나의 케어고치</h2>
