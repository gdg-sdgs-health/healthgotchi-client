...
import { User, LogOut, ChevronRight, ShieldCheck, HelpCircle } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVars} className="mb-8">
        <Card className="border-none shadow-md bg-gradient-to-br from-primary to-pink-400 text-white overflow-hidden">
